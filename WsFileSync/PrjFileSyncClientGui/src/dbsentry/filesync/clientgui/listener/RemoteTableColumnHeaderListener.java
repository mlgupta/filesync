 ...
 *                                                                           *
 *****************************************************************************
 * $Id: RemoteTableColumnHeaderListener.java,v 1.13 2006/05/08 09:40:24 skumar Exp $
 *****************************************************************************
 */
...
/**
 *	A custom Column Header Listener for remote table.
 ...
 */
public class RemoteTableColumnHeaderListener extends MouseAdapter {
  /**
  ...
  public void mousePressed(MouseEvent evt) {
    ...
    if (vColIndex == -1) {
      ...
      if (vColIndex == EnumRemoteTable.NAME) {
